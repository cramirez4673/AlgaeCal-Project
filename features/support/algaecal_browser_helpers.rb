...
require_relative 'algaecal_environment_helpers'

module AlgaeCalBrowsers
	include RSpec::Matchers
  include Selenium

  #### VARIABLES ####
  $algaecal_main_site_url = "#{::EnvironmentHelper.base_url}"

  #### METHODS ####
  def launch_algaecal_browser
    ...
    #### HEADLESS BROWSER
		if ENV['app_type'] == 'headless'
			...
			@website = ENV['target'] || $algaecal_main_site_url
